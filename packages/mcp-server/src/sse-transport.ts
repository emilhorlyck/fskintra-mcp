 ...
 *
 * Adapted from Casperjuel/aula-mcp (MIT), which solved the same problem for
 * the same client. The protocol plumbing is not platform-specific, so this is
 * a near-verbatim port rather than a reimplementation.
 */
